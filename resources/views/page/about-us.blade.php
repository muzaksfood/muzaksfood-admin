...
<nav class="navbar navbar-light bg-light justify-content-between">
    <h1 class="text-primary text-uppercase header-text">{{ Helpers::get_business_settings('restaurant_name') ?? translate('MuzaksFood') }}</h1>
</nav>
...
<div class="container pb-5 mb-2 mb-md-4">
    <div class="row">
        ...
        <section class="col-lg-12">
            {!! Helpers::get_business_settings('about_us') ?? ''  !!}
        </section>
    </div>
</div>
