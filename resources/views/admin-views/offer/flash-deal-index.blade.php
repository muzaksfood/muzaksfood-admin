        ...
        <div class="card mt-4">
            <div class="card--header order-top">
                <div class="d-flex gap-2 align-items-center">
                    <h5 class="mb-0"> {{ translate('Flash Sale List') }}
                        <span class="badge badge-soft-dark rounded-pill fs-10 ml-1">{{ $flashDeals->total() }}</span>
                    </h5>
                </div>
                                ...
                                <td>
                                    <label class="toggle-switch my-0">
                                        <input type="checkbox"class="toggle-switch-input status-change-alert"
                                            id="stocksCheckbox{{ $flash_deal->id }}"
            ...
            <div class="">
                {!! $flashDeals->links('layouts/admin/partials/_pagination', ['perPage' => $perPage]) !!}
            </div>
