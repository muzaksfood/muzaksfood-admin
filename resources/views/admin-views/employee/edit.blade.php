            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">{{translate('First Name')}}</label><span class="input-label-secondary text-danger">*</span>
                                <input type="text" name="first_name" value="{{$employee['f_name']}}" class="form-control" id="name"
                                        placeholder="{{translate('Ex')}} : {{translate('John')}}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">{{translate('Last Name')}}</label><span class="input-label-secondary text-danger">*</span>
                                <input type="text" name="last_name" value="{{$employee['l_name']}}" class="form-control" id="name"
                                        placeholder="{{translate('Ex')}} : {{translate('Joe')}}">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">{{translate('Phone')}}</label><span class="input-label-secondary text-danger">*</span>
                                <input type="text" value="{{$employee['phone']}}" required name="phone" class="form-control" id="phone"
                                        placeholder="{{translate('Ex')}} : +88017********">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">{{translate('Role')}}</label><span class="input-label-secondary text-danger">*</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image" id="customFileUpload" class="custom-file-input h--45px" accept=".jpg, .png, .jpeg" maxlength="{{ \App\CentralLogics\Helpers::readableUploadMaxFileSize('image') }}">
