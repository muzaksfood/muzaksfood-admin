                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" id="customFileUpload" class="custom-file-input h--45px" accept=".jpg, .png, .jpeg" required
                                        maxlength="{{ \App\CentralLogics\Helpers::readableUploadMaxFileSize('image') }}"
                                        >
