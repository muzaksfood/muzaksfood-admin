                                    ...
                                    <div class="d-flex flex-wrap gap-3 align-items-center">
                                        <p class="mb-0">
                                            @if($selectedMaintenanceDuration['maintenance_duration'] == 'until_change')
                                                {{ translate('Your maintenance mode is activated ') }} <strong>{{ translate('until I change') }}</strong>
                                            @else
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="logo" id="customFileEg1" class="custom-file-input"
                                                   accept=".jpg, .png, .jpeg" maxlength="{{ \App\CentralLogics\Helpers::readableUploadMaxFileSize('image') }}">
