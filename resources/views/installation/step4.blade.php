...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ translate('MuzaksFood Software Installation') }}</h2>
        <h6 class="fw-normal">{{ translate('Please proceed step by step with proper data according to instructions') }}</h6>
    </div>

    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="MuzaksFood Software Installation"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-5">
                {{ translate('Your Database has been connected') }} ! {{ translate('Just click on the section to automatically import database') }}
            </p>
            ...
            @else
                <div class="text-center">
                    <a href="{{ route('import_sql',['token'=>bcrypt('step_5')]) }}" class="btn btn-dark px-sm-5 show-loader">
