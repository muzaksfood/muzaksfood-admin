    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'express_delivery' => [
                ...
                'sla_minutes' => (int) (Helpers::get_business_settings('express_delivery_sla_minutes') ?? 10),
                'radius_km' => (float) (Helpers::get_business_settings('express_delivery_radius_km') ?? 3),
            ],
