...
class OrderProvider with ChangeNotifier {
  ...
  Future getAllOrders() async {
    ...
    if (apiResponse.response?.statusCode == 200) {
      ...
      // Sort orders: Express orders first, then by ID
      _currentOrdersReverse?.sort((a, b) {
        // Express orders get priority
        if (a.isExpress == 1 && b.isExpress != 1) return -1;
        if (a.isExpress != 1 && b.isExpress == 1) return 1;
        
        // For express orders, sort by ETA (closest deadline first)
        if (a.isExpress == 1 && b.isExpress == 1) {
          final aEta = a.expressEta != null ? DateTime.tryParse(a.expressEta!) : null;
          final bEta = b.expressEta != null ? DateTime.tryParse(b.expressEta!) : null;
