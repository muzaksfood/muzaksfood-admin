          ...
          child: order.allOrderHistory!.isNotEmpty ? ListView.builder(
            ...
            itemBuilder: (context, index) => InkWell(
              onTap: () {
                ...
                => OrderDetailsScreen(orderId: order.allOrderHistory![index].id)));
              },
              child: Container(
                padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: Theme.of(context).shadowColor.withValues(alpha: .5), spreadRadius: 1, blurRadius: 2, offset: const Offset(0, 1))
                  ],
