...
class _CustomTextFieldWidgetState extends State<CustomTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        widget.showTitle ? Text(widget.hintText!, style: rubikRegular) : const SizedBox(),
      ...
      Container(
        ...
        child: Theme(
          ...
          child: TextField(
            ...
            style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyMedium?.color),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: rubikRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor.withValues(alpha: 0.4)),
              filled: true,
              ...
              prefixIconConstraints: const BoxConstraints(minWidth: 10, maxHeight: 20),
              suffixIcon: widget.isShowSuffixIcon ?
              widget.isPassword ?
              IconButton(
                  icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility, color: Theme.of(context).hintColor.withValues(alpha: .4)),
                  onPressed: _toggle) :
              widget.isIcon ?
              Padding(
                padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge, right: Dimensions.paddingSizeSmall),
