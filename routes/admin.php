...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'employee_active_check']], function () {
        ...
        Route::get('/get-restaurant-data', [SystemController::class, 'restaurantData'])->name('get-restaurant-data');
            ...
            Route::post('business-settings/express/status/{status}', [BusinessSettingsController::class, 'expressDeliveryStatus'])->name('business-settings.express.status');
            Route::post('business-settings/express/update', [BusinessSettingsController::class, 'updateExpressDelivery'])->name('business-settings.express.update');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
            ...
            Route::post('update-extra-discount', [POSController::class, 'updateExtraDiscount'])->name('update-extra-discount');
            Route::post('delete-extra-discount', [POSController::class, 'deleteExtraDiscount'])->name('delete-extra-discount');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('remove-image/{id}/{index}', [ProductController::class, 'removeImage'])->name('remove-image');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::get('verify-offline-payment/{order_id}/{status}', [OrderController::class, 'verifyOfflinePayment'])->name('verify-offline-payment');
            ...
            Route::get('switch-payment/{id}', [OrderController::class, 'switchPaymentMethod'])->name('switch-payment');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
                ...
                // Express Delivery setup page
                Route::get('express-setup', [BusinessSettingsController::class, 'expressSetup'])->name('express-setup');
            ...
            Route::group(['prefix' => 'ai-configuration', 'as' => 'ai-configuration.'], function () {
                Route::get('', [AIConfigurationController::class, 'index'])->name('index');
                Route::post('store', [AIConfigurationController::class, 'store'])->name('store');
            });
        });
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report_management']], function () {
            ...
            Route::get('order', [ReportController::class, 'orderReportIndex'])->name('order');
            Route::get('export-order-report', [ReportController::class, 'exportOrderReport'])->name('export-order-report');
