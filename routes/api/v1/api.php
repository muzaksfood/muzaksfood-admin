...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => ['auth:api', 'customer_is_block']], function () {
        Route::post('add-fund-wallet', [\App\Http\Controllers\PaymentController::class, 'addFund']);
        ...
        Route::post('payment-mobile', [\App\Http\Controllers\PaymentController::class, 'payment'])->middleware('guest_user')->withoutMiddleware('auth:api')->name('payment-mobile');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        Route::group(['middleware' => 'deliveryman_is_active'], function () {
            ...
            Route::delete('delete-account', [DeliverymanController::class, 'deleteAccount']);
        });
